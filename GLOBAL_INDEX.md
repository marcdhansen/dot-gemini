...
**Purpose**: Single point of entry for all agentic knowledge, projects, and rules
across the system.
...
- **LightRAG Workspace** (`~/antigravity_lightrag`)
  ...
  - **Project: LightRAG** (`~/antigravity_lightrag/LightRAG`)
    ...
    - [Architecture Guide](../antigravity_lightrag/LightRAG/docs/ARCHITECTURE.md)
    - **Subsystems**
