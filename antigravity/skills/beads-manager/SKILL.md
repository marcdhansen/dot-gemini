...
name: beads-manager
description: >
  Creates and manages beads issues across multiple repos. Use when creating
  linked issues across repositories, tracking work across agent-harness and
  LightRAG, or managing cross-repo dependencies.
  Do NOT use for single-repo issue management (use bd directly).
compatibility: >
  Requires bd CLI and network access to configured repositories
  (agent-harness, LightRAG, etc.).
metadata:
  author: Workshop Team
  version: "1.0.0"
  category: project-management
  tags: [beads, issue-management, cross-repo, coordination]
  priority: 2
  type: task
