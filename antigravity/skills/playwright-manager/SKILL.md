...
description: >
  Manages Playwright browser processes and tabs. Use when tracking,
  listing, or cleaning up Playwright browser instances, checking how many
  tabs an agent has open, or coordinating browser cleanup after a session.
  Do NOT use for code review, pull requests, CSS, web development
  questions, or any task not specifically about Playwright process
  management.
compatibility: >
  Requires Playwright and Python 3.x. Scripts live in
  ~/.gemini/antigravity/skills/playwright-manager/scripts/.
metadata:
  author: Workshop Team
  version: "1.0.0"
  category: browser-automation
  tags: [browser, playwright, lifecycle, cleanup, cross-agent]
