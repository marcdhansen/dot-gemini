...
> **TDD**: [Full TDD Workflow](../sop/tdd-workflow.md)  
...
Execute the approved plan following TDD and maintaining quality practices.
...
- [ ] **Follow TDD**: Red → Green → Refactor (see [tdd-workflow.md](../sop/tdd-workflow.md))
...
- [ ] Mark items as `[/]` when in progress, `[x]` when completed
